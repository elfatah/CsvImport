 ...
 *
 * Configuring the plugin:  Set the proper settings in config.ini like so:
 *
 * <code>
 ...
 * set this value to split your import into multiple jobs based on the number of
 * CSV rows to process per job.
 *
 ...
 * 5000 rows and then spawn the next job, and so on until the import is
 * completed.
 *
 *
